...
export const presetGroups: PresetGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "tool-approval-inline", label: "Inline approval", description: "Ask above the composer with a compact numbered prompt: Yes, Always, No, or type an answer.", section: "Permissions" },
      { id: "tool-approval-hidden", label: "External approval", description: "Ask above the composer with a full permission card that also shows the tool's arguments.", section: "Permissions" },
